...
const Navbar = () => {
  ...
  return (
    <header className="h-[72px] min-h-[72px] bg-white border-b border-gray-100 flex items-center justify-end px-8 gap-6 z-10 dark:bg-[#16171D] dark:border-gray-800 transition-colors duration-300">
      {/* Theme Toggle */}
      <button
        onClick={toggleTheme}
        className="p-2 rounded-xl text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white transition-all duration-200"
