...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 w-[240px] min-w-[240px] h-screen bg-white border-r border-gray-100 flex flex-col justify-between py-6 px-4 z-20 dark:bg-[#16171D] dark:border-gray-800 transition-colors duration-300">
      ...
      <button
        ...
        className="flex items-center gap-3.5 px-4 py-3 rounded-xl text-[14px] font-medium text-red-500 hover:bg-red-50/50 hover:text-red-600 dark:text-red-400 dark:hover:bg-red-950/20 dark:hover:text-red-300 transition-all duration-200 w-full text-left"
      >
        <LogOut size={18} />
        <span>Logout</span>
      </button>
